# There are a lot of good resources out there, so why another one?
...
- What you produce <!-- .element: class="fragment" -->
- Why <!-- .element: class="fragment" -->
- For whom <!-- .element: class="fragment" -->
- For how much <!-- .element: class="fragment" -->
- and where & how that's communicated <!-- .element: class="fragment" -->
