...
How can we help them find that as fast as possible? <!-- .element: class="fragment" -->
...
- <!-- .element: class="fragment" --> The <strong>best</strong> service provider 
- <!-- .element: class="fragment" --> <strong>Nearest</strong> to them or within a reasonable distance
...
- Information is available that confirms they got the right kind of service provider (relevance) <!-- .element: class="fragment" -->
- Geographical information is available that confirms proximity (relevance) <!-- .element: class="fragment" -->
- There's "proof" the service provider is legit (authority, trustworthiness) <!-- .element: class="fragment" -->
- Contact information is readily available (trustworthiness) <!-- .element: class="fragment" -->
- More information is readily available if desired (authority, trustworthiness) <!-- .element: class="fragment" -->
...
(and keep it updated) <!-- .element: class="fragment" -->

---

## But, there are some "gotchas"...
- It can take a few weeks to receive your confirmation mail, so plan accordingly <!-- .element: class="fragment" -->
- Beware "keyword stuffing" <!-- .element: class="fragment" -->
- Don't be "spammy" or over-exaggerate claims <!-- .element: class="fragment" -->
- Be sure to fill out as much as you possibly can, but it's ok if the honest answer is 'no answer' for some questions <!-- .element: class="fragment" -->
- Filling out your Google Business Profile will get you started and give you a search bump, but it's NOT a silver bullet <!-- .element: class="fragment" -->

(In other words, the bump will fade) <!-- .element: class="fragment" -->
